package jkxy.kafka.producer.sync;
...
public class SyncProduce {
    public static void main(String[] args) {
        ...
        //0：  绝不等确认
        //1:   leader的一个副本收到这条消息，并发回确认
        //-1：   leader的所有副本都收到这条消息，并发回确认
        ...
        for (long nEvents = 0; nEvents < events; nEvents++) {
            ...
            KeyedMessage<String, String> data = new KeyedMessage<String, String>("testData", ip, msg);
